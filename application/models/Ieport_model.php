...
class Ieport_model extends CI_Model
{
   ...
   function restaurantproductaddcsv($data1){
	 	
        $this->db->insert('restaurantproduct', $data1);
		return $this->db->insert_id();
  
   }
     
   function restaurantproductupdatecsv($data, $id){
	...
	public function updatesimplevariantcsv($data, $id){
